...
const navItems = [
  ...
  { path: '/agent', label: 'AI Agent', icon: icons.agent },
...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-dark-card border-r border-gray-200 dark:border-dark-border flex flex-col">
      {/* Logo */}
      <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-dark-border app-drag">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-dark-border">
        ...
        <NavLink
          to="/settings"
          className={({ isActive }) =>
            `nav-item mb-2 ${isActive ? 'nav-item-active' : ''}`
          }
        >
          {icons.settings}
          <span>Settings</span>
